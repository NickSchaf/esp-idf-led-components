...
// Defaults from https://github.com/espressif/arduino-esp32/blob/master/Kconfig.projbuild
...
ip_addr_t AsyncUDPPacket::localIP()
{
    return _localIp;
}
...
ip_addr_t AsyncUDPPacket::remoteIP()
{
    return _remoteIp;
}
